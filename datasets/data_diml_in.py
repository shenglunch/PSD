...
class DIMLiDataset(data.Dataset):
    def __init__(self, cfg, mode='train'):
        super(DIMLiDataset, self).__init__()
        self.cfg = cfg
        self.mode = mode
        self.max = cfg.DIMLi.max
        
        self.valrgb = cfg.DIMLi.valrgb
        self.valgt = cfg.DIMLi.valgt
        self.valraw = cfg.DIMLi.valraw
        ...
        if mode== 'train':
            ...
            self.rgb_files, self.sparse_files, self.target_files = self.load_path(cfg.DIMLi.vallist)
        ...
        if cfg.MDEBranch.backbone == 'midas':
            ...
            self.data_basic = cfg.DIMLi.data_basic
