...
class DIODEoDataset(data.Dataset):
    def __init__(self, cfg, mode='train'):
        super(DIODEoDataset, self).__init__()
        self.cfg = cfg
        self.mode = mode
        self.rate = cfg.DIODEo.rate
        self.max = cfg.DIODEo.max

        self.valrgb = cfg.DIODEo.valrgb
        self.valgt = cfg.DIODEo.valgt
        self.valraw = cfg.DIODEo.valraw
        
        if mode== 'train':
            pass 
        elif mode== 'val':
            self.files = self.load_path(cfg.DIODEo.vallist)
        ...
        if cfg.MDEBranch.backbone == 'midas':
            ...
            self.data_basic = cfg.DIODEo.data_basic
