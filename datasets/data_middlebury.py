...
class MIDDLEBURYDataset(data.Dataset):
    def __init__(self, cfg, mode='val'):
        ...
        self.cfg = cfg
        self.mode = mode
        self.rate = cfg.MIDDLEBURY.rate
        self.max = cfg.MIDDLEBURY.max

        self.valrgb = cfg.MIDDLEBURY.valrgb
        self.valgt = cfg.MIDDLEBURY.valgt
        self.valraw = cfg.MIDDLEBURY.valraw
        self.valk = cfg.MIDDLEBURY.valk
        
        if mode== 'train':
            pass 
        elif mode== 'val':
            self.rgb_files, self.sparse_files, self.target_files, self.intrinsic_files = self.load_path(cfg.MIDDLEBURY.vallist)
        ...
        if cfg.MDEBranch.backbone == 'midas':
            ...
            self.data_basic = cfg.MIDDLEBURY.data_basic
