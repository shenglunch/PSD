...
class VOIDDataset(data.Dataset):
    def __init__(self, cfg, mode='train'):
        ...
        self.cfg = cfg
        self.mode = mode
        self.max = cfg.VOID1500.max
        self.valrgb = cfg.VOID1500.valrgb
        self.valgt = cfg.VOID1500.valgt
        self.valraw = cfg.VOID1500.valraw
        self.valk = cfg.VOID1500.valk
        ...
        if mode== 'train':
            ...
            self.rgb_files, self.sparse_files, self.target_files, self.intrinsic_files = self.load_path(cfg.VOID1500.vallist)
        ...
        if cfg.MDEBranch.backbone == 'midas':
            ...
            self.data_basic = cfg.VOID1500.data_basic
