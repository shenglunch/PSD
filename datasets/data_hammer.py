...
K= [
    7.067553100585937500e+02, 0.000000000000000000e+00, 5.456326819328060083e+02,\
    0.000000000000000000e+00, 7.075133056640625000e+02, 3.899299663507044897e+02,\
    0.000000000000000000e+00, 0.000000000000000000e+00, 1.000000000000000000e+00]

class HAMMERDataset(data.Dataset):
    def __init__(self, cfg, mode='train'):
        super(HAMMERDataset, self).__init__()
        self.cfg = cfg
        self.mode = mode
        self.max = cfg.HAMMER.max
        self.valrgb = cfg.HAMMER.valrgb
        self.valgt = cfg.HAMMER.valgt
        self.valraw = cfg.HAMMER.valraw
        ...
        if mode== 'train':
            ...
            self.rgb_files, self.sparse_files, self.target_files = self.load_path(cfg.HAMMER.vallist)
        ...
        if cfg.MDEBranch.backbone == 'midas':
            ...
            self.data_basic = cfg.HAMMER.data_basic
