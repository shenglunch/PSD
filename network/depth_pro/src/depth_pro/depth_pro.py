...
class DepthPro(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
        all_features, features, features_0 = self.decoder(encodings)
        ...
        return canonical_inverse_depth, fov_deg, all_features
    ...
    def infer(
        ...
        canonical_inverse_depth, fov_deg, all_features = self.forward(x)
        if f_px is None:
    ...
    def infer_inv(
        ...
        return inverse_depth, all_features
